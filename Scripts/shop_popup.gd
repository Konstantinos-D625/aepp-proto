...
const WEAPONS: Array[Dictionary] = [
	{ "name": "Ξίφος Μαθητή",    "desc": "+5 Επίθεση",  "cost": {"Σίδερο": 5,  "Χρυσό": 20},               "icon": "⚔" },
	{ "name": "Δίκοπο Σπαθί",    "desc": "+12 Επίθεση", "cost": {"Σίδερο": 12, "Χρυσό": 60},               "icon": "⚔" },
	{ "name": "Πέλεκυς Πολέμου", "desc": "+20 Επίθεση", "cost": {"Σίδερο": 20, "Κασμίρ": 3, "Χρυσό": 120}, "icon": "🪓" },
]

const ARMOR: Array[Dictionary] = [
	{ "name": "Δερμάτινη Πανοπλία", "desc": "+8 Άμυνα",  "cost": {"Βαμβάκι": 10, "Χρυσό": 15},              "icon": "🛡" },
	{ "name": "Σιδερένια Πανοπλία", "desc": "+18 Άμυνα", "cost": {"Σίδερο": 15, "Χρυσό": 50},               "icon": "🛡" },
	{ "name": "Ασπίδα Ιππότη",      "desc": "+25 Άμυνα", "cost": {"Σίδερο": 10, "Κασμίρ": 5, "Χρυσό": 80},  "icon": "🛡" },
]
...
func _make_item_card(item: Dictionary) -> Control:
	...
	# Κουμπί αγοράς
	var owned: bool = bool(_owned.get(str(item["name"]), false))
	var buy := Button.new()
