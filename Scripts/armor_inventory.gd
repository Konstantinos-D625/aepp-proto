...
func _configure() -> void:
	...
	items = {
		"Θώρακας": [
			...
			{"file": "σιδερενιος", "name": "Ironclad Cuirass",         "stat": 2},
			{"file": "Κρυσταλικός","name": "Runeforged Aegis",         "stat": 3},
			{"file": "Αγγελικός",  "name": "Seraphic Radiance Plate",  "stat": 4},
			{"file": "Παγωμένος",  "name": "Frostfang Glacier Plate",  "stat": 4},
			{"file": "Δαιμονικός", "name": "Hellforged Cuirass",       "stat": 5},
		],
		"Κράνος": [
			{"file": "Γήινο",      "name": "Antlerwood Wildhelm",      "stat": 1},
			{"file": "Σιδερένιο",  "name": "Ironvow Crusader Helm",    "stat": 2},
			{"file": "Κρυσταλικό", "name": "Aethercrest Helm",         "stat": 3},
			{"file": "Αγγελικό",   "name": "Seraph Laurel Helm",       "stat": 3},
			{"file": "Παγωμένο",   "name": "Frostmane Horned Helm",    "stat": 4},
			{"file": "Δαιμονικό",  "name": "Doomhorn Warhelm",         "stat": 5},
		],
		"Παντελόνι": [
			{"file": "Γήινο",      "name": "Bramblewood Legguards",    "stat": 1},
			{"file": "Σιδερένιο",  "name": "Ironclad Legplates",       "stat": 2},
			{"file": "Κρυσταλικό", "name": "Duskcloak Legplates",      "stat": 3},
			{"file": "Αγγελικό",   "name": "Radiant Halo Greaves",     "stat": 4},
			{"file": "Παγωμένο",   "name": "Glacial Ward Greaves",     "stat": 4},
			{"file": "Δαιμονικό",  "name": "Infernal Chainguard",      "stat": 5},
		],
		"Μπότες": [
			{"file": "Γήινες",     "name": "Rootbound Treads",         "stat": 1},
			{"file": "Σιδερένιες", "name": "Ironstep Sabatons",        "stat": 2},
			{"file": "Κρυσταλικές","name": "Aetherstride Boots",       "stat": 3},
			{"file": "Αγγελικές",  "name": "Seraphic Striders",        "stat": 4},
			{"file": "Παγωμένες",  "name": "Frostpaw Greaves",         "stat": 4},
			{"file": "Δαιμονικές", "name": "Infernal Chainboots",      "stat": 5},
		],
	}
