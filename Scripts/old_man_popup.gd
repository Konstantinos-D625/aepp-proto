...
func _build_bubble() -> void:
	...
	const BY := 200.0
	const BW := 600.0
	# Μεγαλωμένο από το αρχικό 640: +54 για το μισό-ορατό 4ο κουμπί στη λίστα
	# θεμάτων (βλ. OPTIONS_SCROLL_H), +166 ακόμα ώστε τα μεγαλύτερα κείμενα
	# θεμάτων (π.χ. «Πώς παλεύεις», «Το Κάστρο») να χωράνε ολόκληρα πάνω απ'
	# το κουμπί «Ρώτα για άλλον» χωρίς να κόβονται.
	const BH := 860.0
