...
# στο Area1.tscn.
#
# ΡΟΗ TUTORIAL: ο γέρος καλωσορίζει και ρωτάει για ποιον τεχνίτη θες να
# μάθεις — 3 επιλογές (Μεταλλωρύχος/Δερματού/Πεταλωτής, βλ. TOPICS). Πατώντας
# μία, το κείμενο της φούσκας αλλάζει σε δυο λόγια για τον τεχνίτη και την
# πρώτη ύλη που δίνει (Χαλκό/Δέρμα/Σίδερο) αν απαντήσεις στις ερωτήσεις του·
# το «Ρώτα για άλλον» γυρνάει στις επιλογές. Δεν υπάρχει «Κατάσταση 2»
# (board/quiz) όπως στους άλλους NPC — μόνο διάλογος.
...
func _build_bubble() -> void:
	...
	# Κουμπιά-θέματα (intro όψη) — μεγέθη δαχτύλου για κινητό (ύψος 84)
	_options_box = VBoxContainer.new()
	_options_box.position = Vector2(BX + 30, BY + BH - 312)
	_options_box.size     = Vector2(BW - 60, 276)
