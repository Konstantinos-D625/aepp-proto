...
# Σε ΝΙΚΗ δίνεται η ανταμοιβή σε Χαλκό (το βασικό νόμισμα αγορών — βλ.
# currency_manager.gd) μέσω του ΥΠΑΡΧΟΝΤΟΣ Currency autoload, και το boss
# κλειδώνει ΟΡΙΣΤΙΚΑ (GameData.record_mini_boss_win): κάθε επόμενη επίσκεψη
# δείχνει «ΝΙΚΗΜΕΝΟ» χωρίς κουμπί επίθεσης. Έτσι η ανταμοιβή δίνεται ΜΙΑ φορά
# — πριν, με απεριόριστες δωρεάν επαναλήψεις, ήταν farmable.
#
