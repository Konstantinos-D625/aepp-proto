...
# Το Κέρμα Φιλίας είναι νέος πόρος (μελλοντικό σύστημα φίλων/κατάταξης) — προς
# το παρόν εμφανίζεται μόνο στα strips (Αποθήκη/Shop)· ΚΑΝΕΝΑ σύστημα δεν το
# χορηγεί ούτε το ξοδεύει ακόμα, οπότε μένει σταθερό στο STARTING_AMOUNTS του.
const ORDER: Array[String] = [
	"Χαλκός", "Δέρμα", "Σίδερο", "Κέρμα", "Κέρμα Φιλίας",
...
const TEXTURE_ICONS := {
	...
	"Κέρμα Φιλίας":      "res://Εικόνες/friendship_coin.png",
	"Αριθμητικό Κλειδί": "res://Εικόνες/key.png",
}
