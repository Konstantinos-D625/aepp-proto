...
// ═══════════════════════════════════════════════════════════════════════════
// Φάση 9 (Κέρματα Φιλίας) — 1 δωρεάν Κέρμα Φιλίας/μέρα σε φίλο, ΜΟΝΟ αν και οι
// δύο έχουν ολοκληρώσει το Daily Quest τους εκείνη τη μέρα.
// ═══════════════════════════════════════════════════════════════════════════
// Κάθε εγγραφή = «ο from_user έδωσε 1 Κέρμα Φιλίας στον to_user, τη μέρα date».
// Το ΑΝ πράγματι και οι δύο έχουν κάνει το Daily Quest ΔΕΝ επαληθεύεται εδώ (θα
// χρειαζόταν cross-collection έλεγχο στο profiles) — ο client δείχνει το κουμπί
// δώρου μόνο όταν πράγματι ισχύει και για τους δύο (βλ. friends_popup.gd), ίδιο
// επίπεδο εμπιστοσύνης με τα υπόλοιπα Phase 5-8 συστήματα (π.χ. τιμές Shop).
// Η ΜΟΝΑΔΙΚΗ πραγματική επιβολή server-side είναι:
